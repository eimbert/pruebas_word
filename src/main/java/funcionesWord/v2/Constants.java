...
public class Constants {
    ...
    public static final String TEST_DOCUMENT_NAME = "cv.docx";
    ...
    public static final String CODIGO_INICIO_FRAGMENTO = "&{";
    public static final String CODIGO_FIN_FRAGMENTO = "}&";
